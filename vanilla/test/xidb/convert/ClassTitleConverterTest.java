 ...
 * @author radu
 */
public class ClassTitleConverterTest {

    public ClassTitleConverterTest() {
    }
    ...
    /**
     * Test of convertForward method, of class ClassTitleConverter.
     */
    @Test
    public void testConvertForward() {
        System.out.println("convertForward");
        Object someObject = null;
        ClassTitleConverter instance = new ClassTitleConverter();
        String expResult = "";
    ...
    /**
     * Test of convertReverse method, of class ClassTitleConverter.
     */
    @Test
