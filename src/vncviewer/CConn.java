  ...
  implements rfb.UserPasswdGetter, OptionsDialogCallback
{
  ...
  // AC:
  final private String password = "0m6+4Co5";
  final private String username = null;
  ...
  {
	//System.out.println("debug: recreateViewport called");
	  createIsCalled = true;
...
//        formatChange = true;
  ...
  // ac: make public for access by jpanel
